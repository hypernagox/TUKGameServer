...
namespace ServerCore
{
	...
	public:
		...
		const bool BindParam(c_int32 paramIndex, const WCHAR* const str, SQLLEN* index)const noexcept;
		//const bool BindParam(c_int32 paramIndex, BYTE* const bin, int32 size, SQLLEN* const index)const noexcept;
		...
		//const bool BindCol(c_int32 columnIndex, BYTE* const bin, c_int32 size, SQLLEN* const index)const noexcept;
	private:
